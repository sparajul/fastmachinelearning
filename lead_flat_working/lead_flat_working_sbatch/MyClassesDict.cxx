...
#define R__DICTIONARY_FILENAME MyClassesDict
...
namespace {
  void TriggerDictionaryInitialization_MyClassesDict_Impl() {
    static const char* headers[] = {
"MyData.h",
nullptr
    };
    static const char* includePaths[] = {
"/cvmfs/sft.cern.ch/lcg/releases/ROOT/6.28.00-a8528/x86_64-centos7-gcc11-opt/include/",
"/scratch/users/santoshp/GEPSample/lead_flat_working/",
nullptr
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "MyClassesDict dictionary forward declarations' payload"
...
#line 1 "MyClassesDict dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("MyClassesDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_MyClassesDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_MyClassesDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_MyClassesDict() {
  TriggerDictionaryInitialization_MyClassesDict_Impl();
}
